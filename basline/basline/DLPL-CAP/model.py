...
class CapClassifier(nn.Module):
    ...
    def __init__(self, hidden_dim, num_classes=None, class_boundaries=None, 
        ...
        """初始化一个空的PyTorch模块列表，用于存储多个GNN层。
            为什么用ModuleList：PyTorch要求所有包含可训练参数的层必须用ModuleList/ModuleDict注册，否则无法识别参数。"""
    ...
    def forward(self, batch):
        ...
        # print("结果", pred)
        # # print("true_class",true_class.size())
        # print("true_label.size", true_label.size())
        # assert 0        
