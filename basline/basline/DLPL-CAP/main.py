...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='./logs_test', help='Directory to save logs.')
    ...
    log_filename = os.path.join(args.log_dir, f"{args.task}_{args.train_dataset}_to_{args.test_dataset}_{args.use_bn}_{args.src_dst_agg}_{args.act_fn}_{args.dropout}.txt")
    ...
    sys.stdout = Tee(original_stdout, log_file)  # 重定向到 Tee 实例
