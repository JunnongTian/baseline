...
def dataset_sampling(args, train_dataset, test_dataset):
    ...
    # 合并节点类型映射
    if hasattr(train_graphs[0], '_n2type'): #节点类型映射
        ...
        _num_etypes = 2  # 共2种边类型
        """
    # 合并边类型映射
    if hasattr(train_graphs[0], '_e2type'): #边类型映射
    ...
    train_loader = LinkNeighborLoader(
        ...
        subgraph_type='bidirectional', #双向
        disjoint=True,
